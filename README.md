...
<tr>
   ...
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t" title="r_{d}^t" /></a>| danger reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.15&space;&&space;broke\:safe\:distance\end{cases}" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.15&space;&&space;broke\:safe\:distance\end{cases}" title="r_{d}^t =\begin{cases}0 & otherwise\\-0.15 & broke\:safe\:distance\end{cases}" /></a>
