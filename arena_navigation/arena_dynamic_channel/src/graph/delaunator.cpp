...
/*
 * If in_speeds and in_angles adopt DEFAULT value, accessing this->speeds
 * and this->angles will lead to errors !
 *
**/
Delaunator::Delaunator(std::vector<double> const& in_coords,
                       std::vector<double> const& in_speeds = DEFAULT_SPEED,
                       std::vector<double> const& in_angles = DEFAULT_ANGLE)
    : speeds(in_speeds),
      angles(in_angles),
      coords(in_coords),
      triangles(),
