...
void PlanManager::init(ros::NodeHandle &nh)
{
  ...
  odom_sub_ = nh.subscribe(ros::this_node::getNamespace()+ros::this_node::getNamespace()+"/odometry/ground_truth", 1, &PlanManager::odometryCallback, this,ros::TransportHints().tcpNoDelay()); // odom  //odometry/ground_truth
