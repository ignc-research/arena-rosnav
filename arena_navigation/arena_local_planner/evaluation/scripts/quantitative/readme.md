...
This section presents information on how to plot quantitative plots. Four different metrics can be plotted: success rate, collision count, time to reach the goal, and path length.
