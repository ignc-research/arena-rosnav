# example 
# python sim_evaluation_v2.py $HOME/arena_ws/src/arena-rosnav/arena_navigation/arena_local_planner/evaluation/scripts/quantitative/run_3 --quantity vel --base cadrl --metrics time path collision success
...
if __name__ == "__main__": # execute code
    ...
    planner = ["cadrl","rlca","teb","mpc"] # all planners, NOTE: classic planners MUST be in the back!!!
    classic = ["teb","mpc"] # classic planners
