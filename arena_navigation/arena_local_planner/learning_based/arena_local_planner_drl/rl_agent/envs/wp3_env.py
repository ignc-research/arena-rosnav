...
class wp3Env(gym.Env):
    ...
    def _pub_action(self, action):
        ...
        action_msg.pose.position.x = robot_position.x + (self.range_circle*math.cos(angle_grad))         
        action_msg.pose.position.y = robot_position.y + (self.range_circle*math.sin(angle_grad))   
    ...
    def step(self, action):
        ...
        #only increase robot position = goal position
