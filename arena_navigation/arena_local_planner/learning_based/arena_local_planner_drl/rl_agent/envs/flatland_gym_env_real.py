...
class FlatlandEnv(gym.Env):
    ...
    def __init__(self, 
        ...
        rospy.logwarn(f"Can't not determinate the number of the environment, training script may crash!2")
    ...
    def reset(self):
        # print("[gym_env]: Entering env_reset")
        # set task
        ...
        if self._extended_eval:
            ...
            self._safe_dist_counter = 0
            self._collisions = 0
        print("[gym_env]: Ready to get new observations")
        obs, _ = self.observation_collector.get_observations()
        print("[gym_env]: Done with reset")
