...
class ObservationCollector():
    ...
    def get_observations(self):
        ...
        if len(self._scan.ranges) > 0:
            ...
            scan = np.ones(self.num_lidar_beams, dtype=float)*100
    ...
    def callback_subgoal(self, msg_Subgoal):
        ...
        # print('x', self._subgoal.x, 'y', self._subgoal.y)
        return
    ...
    def callback_agent_state(self, msg):
            for i, m in enumerate(msg):
                ...
                print(f'the {i}th human is of type', self._human_type[i])
    ...
    def process_robot_state_msg1(self, msg_RobotStateStamped: RobotStateStamped):
