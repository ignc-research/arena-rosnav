...
class ObservationCollectorAllInOne:
    def __init__(self, ns: str, num_lidar_beams: int, lidar_range: float, numb_models: int = 0,
                 include_model_actions: bool = False,train_mode:Optional[bool]=None,no_wait_for_next_circle = False,subgoal_topic_name:str="subgoal"):
        ...
        self._action_frequency = 1 / rospy.get_param("/robot_action_rate",-1)
        ...
        self._no_wait_for_next_circle =  no_wait_for_next_circle
        ...
        self._subgoal_sub = rospy.Subscriber(
            f'{self.ns_prefix}{subgoal_topic_name}', PoseStamped, self.callback_subgoal)
    ...
    def get_observations(self):
        ...
        elif not self._no_wait_for_next_circle:
            try:
