...
class ObservationCollector():
    def __init__(self, ns: str, num_humans:int):
        ...
        self._sub_danger_zone=[None]*num_humans
        #declaration of human infos
        self._human_type, self._human_position, self._human_vel= [None]*num_humans,[None]*num_humans,[None]*num_humans
        self._human_behavior, self._safe_dist, self._dangerAngle=[None]*num_humans,[None]*num_humans,[None]*num_humans
        self._dangerCenter=[None]*num_humans
        ...
        #subscription of human states and danger zones
        ...
        self.sychronized_list=[self._scan_sub, self._robot_state_sub]+self._sub_agent_state+self._sub_danger_zone
    ...
    def get_observations(self):
        ...
        # obs_dict['danger_zone']=self._human_behavior
    ...
    def callback_observation_received(self, *msg):
        ...
        self.callback_danger_zone(msg[-self.num_humans:])
    ...
    # def process_danger_zone(self, msg):
    #     human_type=msg.type
    #     human_pose=self.pose3D_to_pose2D(msg.pose)
    #     human_twist=msg.twist
    #     human_behavior=msg.social_state.strip("\"")
