...
# copied from https://github.com/facebookresearch/detectron2/blob/b033555067e8d8ad705682f984d0969e3bf3d513/detectron2/config/config.py
...
def get_cfg(is_cfg_for_waypoint:Optional[bool] = False )-> CfgNode:
    """
