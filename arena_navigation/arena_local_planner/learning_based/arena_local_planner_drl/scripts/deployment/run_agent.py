...
if __name__ == "__main__":
    ...
    task_manager = get_predefined_task(ns='sim1', mode='ScenerioTask', PATHS=PATHS)
    
    # initialize gym env
    env = DummyVecEnv(
        [lambda: FlatlandEnv(
            'sim1', task_manager, PATHS.get('robot_setting'), PATHS.get('robot_as'), params['reward_fnc'], params['discrete_action_space'], 
