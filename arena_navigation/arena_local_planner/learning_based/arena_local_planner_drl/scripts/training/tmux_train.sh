...
send-keys "python3 scripts/training/train_all_in_one_agent.py --agent $7  --eval_log --tb --n_envs $num_envs --agent_name $agent_name --all_in_one_config $aio_config --pretrain_file $pre_train_file --config $hyperparam" C-m \; \
split-window -h \; \
