...
send-keys "python3 scripts/training/train_all_in_one_agent.py --agent AGENT_4 --eval_log --tb --n_envs $num_envs --agent_name mixed_teb_drl4_rule07_policy4 --all_in_one_config all_in_one_default.json" C-m \; \
split-window -h \; \
