...
if __name__ == "__main__":
    ...
    env = DummyVecEnv(
        [lambda: wp3Env(task_manager, PATHS.get('robot_setting'), PATHS.get('robot_as'), params['reward_fnc'], params['discrete_action_space'], goal_radius=1.00, max_steps_per_episode=200)] * n_envs)
    if params['normalize']:
