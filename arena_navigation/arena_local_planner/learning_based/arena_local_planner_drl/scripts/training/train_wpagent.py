...
from arena_navigation.arena_local_planner.learning_based.arena_local_planner_drl.rl_agent.envs.wp2_env import wpEnv
...
if __name__ == "__main__":
    ...
    env = DummyVecEnv([lambda: wpEnv(task, PATHS.get('robot_setting'), PATHS.get('robot_as'), discrete_action_space, goal_radius=1.25, max_steps_per_episode=150)] * n_envs)
   
    # instantiate eval environment
    eval_env = Monitor(wpEnv(task, PATHS.get('robot_setting'), PATHS.get('robot_as'), discrete_action_space, goal_radius=1.25, max_steps_per_episode=150), PATHS.get('eval'), info_keywords=("done_reason",))
