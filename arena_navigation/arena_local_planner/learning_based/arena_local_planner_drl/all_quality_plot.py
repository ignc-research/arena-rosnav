...
for path in pathes :
    ...
    for j in range(4):
        ...
        for i in range(len(robot_pos_x)) :
            ...
            if i == 0:
                ...
                ax.text(x, y+0.2, '  start 0',color=color[j],fontstyle='oblique',alpha=0.9)
                x_start = x
                y_start = y
                ...
                ax.text(x, y+0.2, 'End                      ',color=color[j],fontstyle='oblique',alpha=0.9)
            ...
            if i % 50 == 0 :
                ...
                ax.text(x, y+0.2, i,color=color[j],fontstyle='oblique',verticalalignment='bottom',alpha=0.9)
                plt.scatter([x], [y],color=color[j],alpha=0.9)
    ...
    for j in np.arange(1,20):
        ...
        for i in range(len(robot_pos_x)) :
            ...
            if i == 0:
                ax.text(x, y+0.2, i,color='tab:brown',alpha= 0.7,fontstyle='oblique')
                x_start = x
                y_start = y
