...
plt.title('Agents success and failure over number of obstacles',fontweight="bold" ,fontsize=10)
...
color1= ['tab:red','tab:blue','tab:green','tab:orange'] 
color2= ['tab:red','tab:blue','tab:green','tab:orange'] 
color3= ['tab:red','tab:blue','tab:green','tab:orange'] 
...
ax.annotate('5 Obs', ( 1.5, 30), ha='center',fontsize=12)
ax.annotate('10 Obs', ( 6.5, 30), ha='center',fontsize=12)
ax.annotate('20 Obs', ( 11.5, 30), ha='center',fontsize=12)
...
# ax.grid()
plt.ylabel('Success and failure in (%) ',fontsize=10)
...
plt.xticks(xs, labels, fontsize = 8)
ax.annotate('5 Obs', ( 1.5, 9), ha='center',fontsize=12)
ax.annotate('10 Obs', ( 6.5, 9), ha='center',fontsize=12)
ax.annotate('20 Obs', ( 11.5,9 ), ha='center',fontsize=12)
...
plt.title('Agents average path length over number of obstacles',fontweight="bold" ,fontsize=10)
for tick in ax.get_xticklabels():
    tick.set_rotation(45)
plt.ylabel('Average path length in (m) ',fontsize=10)
...
fig, ax = plt.subplots() 
plt.title('Agents average time over number of obstacles',fontweight="bold" ,fontsize=10)
plt.xticks(xs, labels, fontsize = 8)
# plt.xlabel('5 Obs                      10 Obs                      20 Obs',fontsize=12)
times =[]
...
for i,bar in enumerate(bar_list) :
    bar.set_color(colors[i])
ax.annotate('5 Obs', ( 1.5, 6), ha='center',fontsize=12)
ax.annotate('10 Obs', ( 6.5, 6), ha='center',fontsize=12)
ax.annotate('20 Obs', ( 11.5,6 ), ha='center',fontsize=12)
for tick in ax.get_xticklabels():
    tick.set_rotation(45)
plt.ylabel('Average time length in (sec) ',fontsize=10)
