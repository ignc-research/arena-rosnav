...
hyperparams = {
    key: None for key in [
        ...
        'train_max_steps_per_episode', 'eval_max_steps_per_episode', 'goal_radius', 'n_envs'
    ]
}
...
class agent_hyperparams(object):
    ...
    :param n_envs: Number of parallel training environments
    ...
    def __init__(self, agent_name: str, robot: str, gamma: float, n_steps: int, ent_coef: float, learning_rate: float, vf_coef: float, max_grad_norm: float, gae_lambda: float,
                 ...
                 train_max_steps_per_episode: int = 150, eval_max_steps_per_episode: int = 150, goal_radius: float = 1.00, n_envs: int=1, n_timesteps: int = 0):
