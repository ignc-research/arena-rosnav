...
<tr>
   ...
   | --------- | ----------- | ----- |
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{s}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{s}^t" title="r_{s}^t" /></a> | success reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{s}^t&space;=\begin{cases}15&space;&&space;goal\:reached\\0&space;&&space;otherwise\end{cases}" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{s}^t&space;=\begin{cases}15&space;&&space;goal\:reached\\0&space;&&space;otherwise\end{cases}" title="r_{s}^t =\begin{cases}15 & goal\:reached\\0 & otherwise\end{cases}" /></a>
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{c}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{c}^t" title="r_{c}^t" /></a> | collision reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{c}^t&space;=\begin{cases}0&space;&&space;otherwise\\-10&space;&&space;agent\:collides\end{cases}" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{c}^t&space;=\begin{cases}0&space;&&space;otherwise\\-10&space;&&space;agent\:collides\end{cases}" title="r_{c}^t =\begin{cases}0 & otherwise\\-10 & agent\:collides\end{cases}" /></a>
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t" title="r_{d}^t" /></a>| danger reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.15&space;&&space;agent\:oversteps\:safe\:dist\end{cases}" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.15&space;&&space;agent\:oversteps\:safe\:dist\end{cases}" title="r_{d}^t =\begin{cases}0 & otherwise\\-0.15 & agent\:oversteps\:safe\:dist\end{cases}" /></a>
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{p}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{p}^t" title="r_{p}^t" /></a> | progress reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t&space;=&space;w*d^t,&space;\quad&space;d^t=d_{ag}^{t-1}-d_{ag}^{t}\\&space;w&space;=&space;0.25&space;\quad&space;d_{ag}:agent\:goal&space;\:&space;distance" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t&space;=&space;w*d^t,&space;\quad&space;d^t=d_{ag}^{t-1}-d_{ag}^{t}\\&space;w&space;=&space;0.25&space;\quad&space;d_{ag}:agent\:goal&space;\:&space;distance" title="r_{d}^t = w*d^t, \quad d^t=d_{ag}^{t-1}-d_{ag}^{t}\\ w = 0.25 \quad d_{ag}:agent\:goal \: distance" /></a>
   | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{m}^t" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{m}^t" title="r_{m}^t" /></a> | move reward | <a href="https://www.codecogs.com/eqnedit.php?latex=r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.01&space;&&space;agent\:stands\:still\end{cases}" target="_blank"><img src="https://latex.codecogs.com/png.latex?r_{d}^t&space;=\begin{cases}0&space;&&space;otherwise\\-0.01&space;&&space;agent\:stands\:still\end{cases}" title="r_{d}^t =\begin{cases}0 & otherwise\\-0.01 & agent\:stands\:still\end{cases}" /></a>
