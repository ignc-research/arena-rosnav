...
adult_robot_distance = np.nan_to_num( np.array(data['nearest distance for adult']),nan=random.randint(3,18))
child_robot_distance = np.nan_to_num(  np.array(data['nearest distance for child']) ,nan=random.randint(3,18))
elder_robot_distance = np.nan_to_num(  np.array(data['nearest distance for elder']),nan=random.randint(3,18))
forklift_robot_distance =np.nan_to_num(   np.array(data['nearest distance for forklift']) ,nan=random.randint(3,18))
servicerobot_robot_distance = np.nan_to_num(  np.array(data['nearest distance for servicerobot']) ,nan=random.randint(3,18))
random_wanderer_robot_distance = np.nan_to_num(  np.array(data['nearest distance for random_wanderer']) ,nan=random.randint(3,18))
