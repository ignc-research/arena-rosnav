...
constexpr double infinity = 1 >> 20;
struct GridNode;
...
struct GridNode
{
	...
	double gScore{infinity}, fScore{infinity};
	GridNodePtr cameFrom{NULL};
};

class NodeComparator_dyn
{
public:
...
private:
	...
	inline bool checkOccupancy(const Eigen::Vector2d &pos) { return (bool)grid_map_->getFusedInflateOccupancy(pos); }
	...
	std::priority_queue<GridNodePtr, std::vector<GridNodePtr>, NodeComparator_dyn> openSet_;
