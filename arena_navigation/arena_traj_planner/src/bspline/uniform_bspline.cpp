...
// The dimension of a control point is determined by column number
...
void UniformBspline::parameterizeToBspline(const double &ts, const vector<Eigen::Vector2d> &point_set,
