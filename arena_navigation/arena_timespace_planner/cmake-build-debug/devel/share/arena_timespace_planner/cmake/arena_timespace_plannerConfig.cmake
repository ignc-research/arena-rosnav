...
if(NOT "/home/johannes/catkin_ws/src/arena-rosnav/arena_navigation/arena_timespace_planner/include " STREQUAL " ")
  set(arena_timespace_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/johannes/catkin_ws/src/arena-rosnav/arena_navigation/arena_timespace_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arena_timespace_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/johannes/catkin_ws/src/arena-rosnav/arena_navigation/arena_timespace_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/johannes/catkin_ws/src/arena-rosnav/arena_navigation/arena_timespace_planner/cmake-build-debug/devel/lib;/home/johannes/catkin_ws/devel/lib;/opt/ros/melodic/lib)
