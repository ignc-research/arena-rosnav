...
class TaskGenerator:
    def __init__(self):
        ...
        rospy.set_param("/obstacles/static/number", rospy.get_param("~num_static_obs"))
        rospy.set_param("/obstacles/static/min_num_vertices", rospy.get_param("~min_static_num_vertices"))
        rospy.set_param("/obstacles/static/max_num_vertices", rospy.get_param("~max_static_num_vertices"))
        rospy.set_param("/obstacles/dynamic/number", rospy.get_param("~num_dynamic_obs"))
        rospy.set_param("/obstacles/dynamic/min_radius", rospy.get_param("~min_dyn_radius"))
        rospy.set_param("/obstacles/dynamic/max_radius", rospy.get_param("~max_dyn_radius"))
        rospy.set_param("/obstacles/dynamic/min_vel", rospy.get_param("~min_dyn_vel"))
        rospy.set_param("/obstacles/dynamic/max_vel", rospy.get_param("~max_dyn_vel"))
