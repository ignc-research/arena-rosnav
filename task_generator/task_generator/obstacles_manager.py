...
class ObstaclesManager:
    ...
    def register_random_dynamic_obstacles(self, num_obstacles: int, linear_velocity=2, angular_velocity_max=math.pi/6, min_obstacle_radius=0.5, max_obstacle_radius=0.5):
