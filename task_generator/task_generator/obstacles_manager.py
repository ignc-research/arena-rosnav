...
class ObstaclesManager:
    ...
    def register_random_dynamic_obstacles(self, num_obstacles: int, linear_velocity=0.25, angular_velocity_max=math.pi/4, min_obstacle_radius=0.27, max_obstacle_radius=0.33):
