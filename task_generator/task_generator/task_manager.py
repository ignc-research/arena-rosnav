# task manager created by Johannes Cox
# https://github.com/ignc-research/arena-rosnav/blob/drl_all_in_one_planner_johannes/arena_navigation/arena_local_planner/learning_based/arena_local_planner_drl/rl_agent/utils/all_in_one_planner/task_manager.py
