...
```
5. [Terminal 4] Start rosbag recording and name it with following convention: planner_wp-gen_map_obstacles_velocity_subgoal_mode
```
rosbag record -o drl1_map1_obs20_vel_01_subgoal_mode /scenario_reset -e "(.*)police(.*)"

```
* rosbag parameter
  * name of the bag: 
    * [local_planner]_[map_name]_obs[number]_vel_[obs_velocity_magnitude]
    * [drl1]_[map1]_obs[20]_vel_[01]
    * [mpc]_[map]_obs[10]_vel_[02]
